...
namespace DoctorAppointment_ManagementSystem.Controllers
{
    ...
    public class SpecializationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SpecializationId,specializationName")] Specialization specialization)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SpecializationId,specializationName")] Specialization specialization)
        {
            if (ModelState.IsValid)
            {
