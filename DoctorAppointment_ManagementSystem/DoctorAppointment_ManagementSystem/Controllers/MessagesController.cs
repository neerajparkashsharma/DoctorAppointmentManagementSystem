...
namespace DoctorAppointment_ManagementSystem.Controllers
{
    public class MessagesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,EmailAddress,Message1")] Message message)
        {
        ...
        [ValidateAntiForgeryToken]
        [CustomAuthorizationFilter("Admin")]
        public ActionResult Edit([Bind(Include = "ID,Name,EmailAddress,Message1")] Message message)
        {
            if (ModelState.IsValid)
            {
